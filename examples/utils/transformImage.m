...
%[new_im, xdata, ydata] = imtransform(I, TM,'XYScale',1,'FillValues', double(mean( reshape( I, [], 3 ), 1 )'));
%[new_im, xdata, ydata] = imtransform(I, TM,'XYScale',1,'FillValues', double(mean(I(:))));
